...
setup(name='traitar',
        ...
        package_data = {"traitar": ["data/sorted_accessions.txt", "data/models/phypat+GGL.tar.gz", "data/models/phypat.tar.gz", "data/sample_data/NC_000908.fna",  "data/sample_data/NC_016807.fna", "data/sample_data/samples.txt"]},
        zip_safe=False,
